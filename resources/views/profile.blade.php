...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-xlg-9 col-md-7">
      <div class="card">
        <div class="card-body">
          <form class="form-horizontal form-material mx-2" method="POST" action="/home/update_profile" enctype="multipart/form-data">
            @csrf
            @method('PUT')
      ...
      <div class="card mt-5">
        <div class="card-body">
          <form class="form-horizontal form-material mx-2" method="POST" action="/home/update_password" enctype="multipart/form-data">
            @csrf
            @method('PUT')
